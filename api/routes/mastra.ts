...
import { OrchestrateRequest } from '../types/index.js';
...
export default async function(app: FastifyInstance) {
  ...
  app.post<{ Body: OrchestrateRequest }>('/api/agent/orchestrate', {
    ...
    try {
      ...
      // Example analysis prompt that should trigger weather tool usage
...
Please use tools to fetch current weather information if relevant to the task.`;
      ...
      console.log('Expecting tool usage for weather data...');
